...
export default function Chatbot() {
    ...
    // Cargar la API key cuando el componente se monte
    useEffect(() => {
        // En Next.js del lado del cliente, necesitamos acceder a las variables
        // de entorno de esta manera (solo las que tienen el prefijo NEXT_PUBLIC_)
    ...
    const fetchAIResponse = async (userMessage) => {
        ...
        try {
            ...
            console.log("Using API key:", apiKey.substring(0, 3) + "..." + apiKey.substring(apiKey.length - 3)); // Solo para depuración
            ...
            // Modificación para manejar el campo reasoning si content está vacío
            let messageContent = "";
    ...
    // Función para eliminar bloques de código como ```text ... ``` o \boxed{```text ... ```}
    const cleanMarkdown = (text) => {
        // Eliminar \boxed{} que envuelve el código
        let cleanedText = text.replace(/\\boxed\{([\s\S]*?)\}/g, '$1');
        
        // Si el texto comienza y termina con ```text y ```, los eliminamos
